...
app.post('/api/animals', (req, res) => {
    ...
    if (!validateAnimal(req.body)) {
        ...
        // anything in the 400 range means that it's a user error, not a server error
...
// if user names a request to routes that dont exist (wildcard routes)
// ORDER MATTERS! windcard route should be after all the other routes
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, './public/index.html'));
});
